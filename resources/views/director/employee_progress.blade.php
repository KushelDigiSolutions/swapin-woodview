<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-5 mt-2">
            {{ __('Survay Management Employees') }}
        </h2>
        <div class="flex flex-row justify-between items-center">
            ...
            <div>
                {{-- <a href="{{ route('addUser') }}"
                    class="flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"  disabled>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-100 text-sm">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @foreach ($subordinates as $subordinate)
                        <h3 class="my-4 font-extrabold capitalize">{{ $subordinate->name }}</h3>
                        <table class="min-w-full divide-y divide-gray-200 mt-4">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @php
                                    $count = 1;
                                @endphp
                                @foreach ($subordinate->usersurveys as $usersurvey)
                                    <tr>
