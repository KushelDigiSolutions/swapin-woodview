        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-100 text-sm">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @endif
                    <h1 class="text-2xl font-bold mb-4 mt-8 text-center">{{ $survey->title }} of {{ $surveyUser->name }}
                    </h1>

                    <div class="flex items-center text-sm text-gray-500 mb-2 mx-4 justify-between">
                        <div>
                            <span class="mr-2">End Date: {{ $survey->end_date }}</span>
                            <span class="mr-2 text-green-700">Percentage Compleated:
                                {{ $surveyUser->userSurveys->where('survey_id', $survey->id)->first()->percentCompleted }}%</span>
                            <span>Status: <span
